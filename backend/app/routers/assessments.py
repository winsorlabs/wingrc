...
from ..models import Assessment, AssessmentObjective, Control, ControlState
...
def list_control_states(
    ...
    stmt = (
        select(ControlState, AssessmentObjective, Control)
    ...
    return [
        ...
        for cs, obj, ctrl in session.execute(stmt).all()
    ]
